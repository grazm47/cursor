...
dobrynya_bot = DobrynyaAIFullBot()
...
🤖 Я подключен к нейросети GigaChat для умных ответов!
...
def ask_ai_question(message):
    ...
    question_text = """🤖 Задайте любой вопрос Добрыне!

Я подключен к нейросети GigaChat и могу ответить на любые вопросы о:
